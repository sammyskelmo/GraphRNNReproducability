...
def compute_mmd(samples1, samples2, kernel, is_hist=True, *args, **kwargs):
    ...
    return disc(samples1, samples1, kernel, is_parallel=False, *args, **kwargs) + disc(samples2, samples2, kernel, is_parallel=False, *args, **kwargs) - 2 * disc(samples1, samples2, kernel,
                                                                                                                                                                  is_parallel=False, *args, **kwargs)
